package com.cesela.gmall.cart.controller;
...
import com.cesela.gmall.util.CookieUtil;
...
public class CartController {
    ...
    public String addToCart(String skuId, int quantity, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StringUtils.isBlank(memberId)) {
            ...
            // 用户已经登录
            // 从db中查出购物车数据
            OmsCartItem omsCartItemFromDb = cartService.ifCartByUser(memberId,skuId);
    ...
    public String checkCart(String isChecked, String skuId, HttpServletResponse response, HttpServletRequest request, HttpSession session, ModelMap map) {
        String memberId = (String)request.getAttribute("memberId");
        String nickname = (String)request.getAttribute("nickname");
